...
# from helpers import get_frequencies, get_encoded, DATA_DIR
#
#
# class Constants(Enum, str):
...
#         self.head = None
#
#     def build_tree(self, input_text=Constants.FREQUENCIES):
#
#         frequencies = get_frequencies(input_text)
#         priority_queue = PriorityQueue()
#
#         for k, v in frequencies.items():
#             priority_queue.push(HuffmanNode([k], v, None, None))
#
#         left = priority_queue.pop()
#         right = priority_queue.pop()
#         while left and right:
#             priority_queue.push(HuffmanNode(left.char_list + right.char_list, left.freq + right.freq, left, right))
#             left = priority_queue.pop()
#             right = priority_queue.pop()
#
#         self.head = left
...
#
#     def encode(self, node, value=""):
#         new_val = value = str(node.)
#
#
#
# class HuffmanTree:
